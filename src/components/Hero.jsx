    ...
    <section className="relative min-h-[90vh] w-full overflow-hidden bg-slate-950 text-white">
      ...
      <div className="relative z-10 mx-auto flex max-w-7xl flex-col items-center px-6 pt-28 pb-20 text-center">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          <a href="#pricing" className="rounded-lg bg-emerald-400 px-5 py-3 text-sm font-semibold text-slate-900 shadow-sm transition hover:bg-emerald-300">
            Get Started
          </a>
          <a href="#features" className="rounded-lg border border-white/20 bg-white/10 px-5 py-3 text-sm font-semibold text-white transition hover:bg-white/15">
            Explore Features
          </a>
        </div>
